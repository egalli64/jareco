...
public class Subscribing {
    ...
    public static void main(String[] args) {
         ...
         */
        Mono<Integer> m0 = MyPublishers.solution();
        ...
        Flux<Integer> f2 = MyPublishers.diceValuesNoFour();
        ...
        Flux<Integer> f3 = MyPublishers.diceValues();
